...
export function ContactSection() {
  return (
    <section
      className="anchor-target section-shell py-16 sm:py-20"
      id="contact"
    >
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        {/* Left column: heading + questions + buttons */}
        <div>
          <SectionHeading
            eyebrow="Contact"
        ...
        {/* Right column on desktop, below buttons on mobile */}
        <ContactForm />
      </div>

      {/* Tool logos — full width below both columns */}
